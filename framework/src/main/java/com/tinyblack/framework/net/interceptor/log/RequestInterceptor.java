...
import com.tinyblack.framework.BuildConfig;
...
//        printLevel = BuildConfig.DEBUG ? RequestInterceptor.Level.ALL : Level.NONE;
        printLevel =  RequestInterceptor.Level.ALL;
    }
    ...
    public static boolean isText(MediaType mediaType) {
        if (null == mediaType || null == mediaType.type()) {
            return false;
        }
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        try {
            ...
            TLog.w("RequestInterceptor Http Error: " + e);
            throw e;
        }
