...
import static com.tinyblack.framework.log.TLog.assertInitialization;
...
public class LogUtils {
  ...
  public static String formatJson(String json) {
    ...
    return TLog.sLogConfiguration.jsonFormatter.format(json);
  }
  ...
  public static String formatXml(String xml) {
    assertInitialization();
    return TLog.sLogConfiguration.xmlFormatter.format(xml);
  }
  ...
  public static String formatThrowable(Throwable throwable) {
    assertInitialization();
    return TLog.sLogConfiguration.throwableFormatter.format(throwable);
  }
  ...
  public static String formatThread(Thread thread) {
    assertInitialization();
    return TLog.sLogConfiguration.threadFormatter.format(thread);
  }
  ...
  public static String formatStackTrace(StackTraceElement[] stackTrace) {
    assertInitialization();
    return TLog.sLogConfiguration.stackTraceFormatter.format(stackTrace);
  }
  ...
  public static String addBorder(String[] segments) {
    assertInitialization();
    return TLog.sLogConfiguration.borderFormatter.format(segments);
  }
