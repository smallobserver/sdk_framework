...
import com.tinyblack.framework.log.interceptor.Interceptor;
import com.tinyblack.framework.log.internal.DefaultsFactory;
import com.tinyblack.framework.log.internal.Platform;
import com.tinyblack.framework.log.internal.util.StackTraceUtil;
import com.tinyblack.framework.log.printer.Printer;
import com.tinyblack.framework.log.printer.PrinterSet;
 ...
 * <br>Using one of
 * <br>{@link TLog#init()}
 * <br>{@link TLog#init(int)},
 * <br>{@link TLog#init(LogConfiguration)}
 * <br>{@link TLog#init(Printer...)},
 * <br>{@link TLog#init(int, Printer...)},
 * <br>{@link TLog#init(LogConfiguration, Printer...)},
 ...
 * <p>
 * <b>4. Start to log.</b>
 * <br>The logging methods of a {@link Logger} is completely same as that ones in {@link TLog}.
...
public class TLog {
    ...
    /**
     * Global logger for all direct logging via {@link TLog}.
     */
    ...
    static LogConfiguration sSimpleLogConfiguration;
    ...
    public static void init(LogConfiguration logConfiguration, Printer... printers) {
        if (sIsInitialized) {
            Platform.get().warn("TLog is already initialized, do not initialize again");
        }
        sIsInitialized = true;
        ...
        sSimpleLogConfiguration = new LogConfiguration.Builder()
    ...
    static void assertInitialization() {
        if (!sIsInitialized) {
            throw new IllegalStateException("Do you forget to initialize TLog?");
        }
    }
    ...
    public static void i(String msg, boolean simpleLog) {
        assertInitialization();
        if (simpleLog) {
            sLogger.setLogConfiguration(sSimpleLogConfiguration);
        }
        sLogger.i(msg);
        sLogger.setLogConfiguration(sLogConfiguration);
    }
     ...
     *
     * @deprecated please use {@link TLog} instead
     */
