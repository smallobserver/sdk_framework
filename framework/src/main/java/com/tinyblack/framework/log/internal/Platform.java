...
import com.tinyblack.framework.log.formatter.message.object.BundleFormatter;
import com.tinyblack.framework.log.formatter.message.object.IntentFormatter;
...
public class Platform {
  ...
  static class Android extends Platform {
    ...
    @Override
    public void warn(String msg) {
      android.util.Log.w("TLog", msg);
    }

    @Override
    public void error(String msg) {
      android.util.Log.e("TLog", msg);
    }
  }
}
